...
fun PurchaseInvoiceScreen(
    vm: PurchaseInvoiceViewModel = hiltViewModel(),
    modifier: Modifier = Modifier
) {
    val listItems = vm.purchaseInvoicesList.collectAsLazyPagingItems()
    ...
    Column() {
        ...
        LazyColumn {
            items(
                ...
                item?.let { PurchaseInvoiceCard(it) }
...
@Preview
@Composable
fun PreviewPurchaseInvoiceCard() {
    PurchaseInvoiceCard(
        PurchaseInvoiceSummaryVO(
            id = 1,
            sn = "123456",
            purchaseOrderId = 1,
            supplierName = "供应商1",
...
@Composable
fun PurchaseInvoiceCard(invoice: PurchaseInvoiceSummaryVO ){
