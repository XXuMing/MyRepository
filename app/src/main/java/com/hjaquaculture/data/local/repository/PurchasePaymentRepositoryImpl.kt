...
@Singleton
class PurchasePaymentRepositoryImpl @Inject constructor(
    private val database: LocalDatabase,
    private val dao: PurchasePaymentDao,
    private val orderManager: OrderManager
): PurchasePaymentRepository {

    override suspend fun addPurchasePayment(purchasePayment: PurchasePayment): Long{
        return database.withTransaction {
            val newId = dao.insert(purchasePayment)
